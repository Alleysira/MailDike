package com.example.trytolearn.CPABEAPP;
...
public class CPABE {
    ...
    public PairingKeySerParameter getpublickey(String out_pubkey_p, String out_pubkey_g,
        ...
        Element publickey_f = pairing.getGT().newElementFromBytes(f);
        Element publickey_eggAlpha = pairing.getGT().newElementFromBytes(eggAlpha);
    ...
    public PairingKeySerParameter getmasterkey(String out_masterkey_p, String out_masterkey_gAlpha, String out_masterkey_Beta) {
        ...
        Element masterkey_Beta = pairing.getZr().newElementFromBytes(Beta);
