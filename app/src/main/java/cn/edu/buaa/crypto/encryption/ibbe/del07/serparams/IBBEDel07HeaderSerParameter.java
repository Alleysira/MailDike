 ...
 */
public class IBBEDel07HeaderSerParameter extends PairingCipherSerParameter {
    ...
    public IBBEDel07HeaderSerParameter(PairingParameters pairingParameters, Element C1, Element C2) {
    ...
    public boolean equals(Object anObject) {
        ...
        if (anObject instanceof IBBEDel07HeaderSerParameter) {
            IBBEDel07HeaderSerParameter that = (IBBEDel07HeaderSerParameter) anObject;
            //Compare C1
